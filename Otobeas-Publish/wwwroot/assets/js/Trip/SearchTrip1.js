    ...
    try {
        ...
        $.ajax({
            ...
            success: function (res) {
                console.log(res)
                if (res.isValid) {
                    $("#favoriteBtn" + boarding_id).off('click');
                    $("#favoriteBtn" + boarding_id).unbind('click');
...
$("#from").change(function () {
    ...
    if (exists) {
        ...
        $.get("/Site/InternationalStations", {
        },
            function (data) {
                stations = data;
                $("#from").empty();
...
function SearchTrip() {
    window.location.href = '/BookingSearch?from=' + $("#from").val() + '&to=' + $("#to").val() + '&travelDate=' + $("#goingDate").val() + '&travelBackDate=' + $("#returnDate").val()
}
